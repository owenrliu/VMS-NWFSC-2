...
figs_baVn <- ba.boot.means.n %>% ungroup() %>%
  ...
  geom_point() +
  facet_wrap(~sample) + 
  labs(y="Overlap (BA index)", x="Count") + theme_bw()

figs_baVn
```
```{r echo=FALSE, eval=writing}
png(here::here('project-dat','figures',"FigS_BAoverlap-bootstrapped_v_SubgroupSampleSize_2013-18.png"),res=200,width=1600,height=1000)
figs_baVn
dev.off()
```
