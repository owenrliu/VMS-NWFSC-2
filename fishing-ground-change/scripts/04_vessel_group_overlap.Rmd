...
Generate SpatialPointsDataFrame for each vessel group, to be used for home range estimation. Will also produce sample size information for each cluster.
...
indir <- "HomeRange/R_Output"
clustdir<-"HomeRange/R_Output/kmeans_groups/fishing_blocks"
outdir <- "HomeRange/R_Output/home_range/by_district"
```
<br>
