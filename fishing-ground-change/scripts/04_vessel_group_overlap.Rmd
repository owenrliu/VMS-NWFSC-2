...
Input
```{r}
crab_years <- c(2012,2013,2014,2015,2016,2017,2018)
...
Save sample sizes
```{r}
write_csv(sample_sizes,here(outdir,paste0('sample_sizes_',substr(tail(crab_years,1),3,4), 'crabYrs.csv')))
```
...
```{r}
write_csv(ba.dat, here(outdir,paste0("BAoverlap_rawPairwise_",substr(tail(crab_years,1),3,4), 'crabYrs_noncon.csv')))
```
