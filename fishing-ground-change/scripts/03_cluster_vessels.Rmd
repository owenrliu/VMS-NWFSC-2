...
if(write){
write.csv(drvid_subgroups, here('project-dat','vessel_groups',paste0('k',k,'_NaNspeedfilter_',cluster_year,'clusterYR_byArea_sample-sizes.csv')))
}
```
<br>
...
write.csv(subgroup_out, here('project-dat','vessel_groups',paste0('k',k,'_NaNspeedfilter_',cluster_year,'clusterYR_byArea_noncon-group-key.csv')))
}
```
