...
heatwave_profit_barplot <- heatwave_profit_summ %>% 
  ...
  annotate('text',label="*",size=8,x=2.23,y=105)+
  annotate('text',label="*",size=8,x=3.23,y=157)+
  annotate('text',label="*",size=8,x=4.23,y=225)+
  theme(panel.grid.major=element_blank(),
        panel.grid.minor=element_blank(),
        axis.title=element_text(family="sans",size=14,color="black"),
...
heatwave_non_dcrb_barplot <- mhw_outside_revenue %>%  
  ...
  annotate("text",x=2.22,y=500,label="*",size=8)+
  annotate("text",x=4.22,y=1000,label="*",size=8)+
...
mhw_homeranges_plot <-mhw_homeranges_summ %>% 
  ...
  annotate("text",label="*",x=3.23,y=4150,size=8)+
  annotate("text",label="*",x=4.23,y=6550,size=8)+
  theme(panel.grid.major=element_blank(),
        panel.grid.minor=element_blank(),
        legend.position = c(0.2,0.8),
        axis.title=element_text(family="sans",size=10,color="black"))
