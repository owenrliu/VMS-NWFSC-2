...
fishtix_plus <- fishtix %>%
  ...
  distinct(date,drvid,crab_season,agency_code,Rec_ID,DCRB_revenue,DCRB_lbs,SABL_revenue,LOBS_revenue,SPRW_revenue,trip_dur) %>%
...
What about total revenue gained from the Dungeness fishery over the course of the entire season? Remember that especially Group 3 vessels have short, derby seasons.
