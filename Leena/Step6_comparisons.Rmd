...
```
```{r}
points_owen2018 <- owendat2018_step2 %>% group_by(Rec_ID) %>% summarise(n_owen = n())
points_Leena2018 <- Leenadat2018_step2 %>% group_by(Rec_ID) %>% summarise(n_leena = n())
...
```{r}
identical(owendat2018_step3, Leenadat2018_step3) #

all.equal(owendat2018_step3, Leenadat2018_step3) #
